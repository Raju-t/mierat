...
class CrudShowDetailController {
/*@ngInject*/
...
export default angular.module('mcrud.crudShowDetail', [filters])
  .component('crudShowDetail', {
    template: require('./showdetail.html'),
    controller: CrudShowDetailController,
